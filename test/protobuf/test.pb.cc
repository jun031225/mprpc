...
PROTOBUF_CONSTEXPR GetUsersListRequest::GetUsersListRequest(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.id_)*/0u
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct GetUsersListRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR GetUsersListRequestDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~GetUsersListRequestDefaultTypeInternal() {}
  union {
    GetUsersListRequest _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GetUsersListRequestDefaultTypeInternal _GetUsersListRequest_default_instance_;
PROTOBUF_CONSTEXPR GetUsersListResponse::GetUsersListResponse(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.users_)*/{}
  , /*decltype(_impl_.resultcode_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct GetUsersListResponseDefaultTypeInternal {
  PROTOBUF_CONSTEXPR GetUsersListResponseDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~GetUsersListResponseDefaultTypeInternal() {}
  union {
    GetUsersListResponse _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GetUsersListResponseDefaultTypeInternal _GetUsersListResponse_default_instance_;
}  // namespace fixbug
...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, _impl_.resultcode_),
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetUsersListRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetUsersListRequest, _impl_.id_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetUsersListResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetUsersListResponse, _impl_.resultcode_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetUsersListResponse, _impl_.users_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 44, -1, -1, sizeof(::fixbug::GetUsersListRequest)},
  { 51, -1, -1, sizeof(::fixbug::GetUsersListResponse)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::fixbug::_GetUsersListRequest_default_instance_._instance,
  &::fixbug::_GetUsersListResponse_default_instance_._instance,
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "8\001\"H\n\rLoginResponse\022&\n\nresultcode\030\001 \001(\0132"
  "\022.fixbug.ResultCode\022\017\n\007success\030\002 \001(\010\"[\n\004"
  "User\022\014\n\004name\030\001 \001(\014\022\013\n\003age\030\002 \001(\r\022\035\n\003sex\030\003"
  " \001(\0162\020.fixbug.User.Sex\"\031\n\003Sex\022\007\n\003MAN\020\000\022\t"
  "\n\005WOMAN\020\001\"!\n\023GetUsersListRequest\022\n\n\002id\030\001"
  " \001(\r\"[\n\024GetUsersListResponse\022&\n\nresultco"
  "de\030\001 \001(\0132\022.fixbug.ResultCode\022\033\n\005users\030\002 "
  "\003(\0132\014.fixbug.User2\215\001\n\016UserServiceRpc\0224\n\005"
  "Login\022\024.fixbug.LoginRequest\032\025.fixbug.Log"
  "inResponse\022E\n\010GetUsers\022\033.fixbug.GetUsers"
  "ListRequest\032\034.fixbug.GetUsersListRespons"
...
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 654, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
class LoginResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& resultcode(const LoginResponse* msg);
};

const ::fixbug::ResultCode&
LoginResponse::_Internal::resultcode(const LoginResponse* msg) {
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_resultcode()) {
    _this->_impl_.resultcode_ = new ::fixbug::ResultCode(*from._impl_.resultcode_);
  }
...
void LoginResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_resultcode()) {
    _this->_internal_mutable_resultcode()->::fixbug::ResultCode::MergeFrom(
...
void LoginResponse::InternalSwap(LoginResponse* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(LoginResponse, _impl_.resultcode_)>(
          reinterpret_cast<char*>(&_impl_.resultcode_),
          reinterpret_cast<char*>(&other->_impl_.resultcode_));
}
...
class GetUsersListRequest::_Internal {
 public:
};

GetUsersListRequest::GetUsersListRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fixbug.GetUsersListRequest)
}
GetUsersListRequest::GetUsersListRequest(const GetUsersListRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  GetUsersListRequest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.id_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetUsersListRequest)
}

inline void GetUsersListRequest::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
GetUsersListRequest::~GetUsersListRequest() {
  // @@protoc_insertion_point(destructor:fixbug.GetUsersListRequest)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void GetUsersListRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void GetUsersListRequest::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void GetUsersListRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetUsersListRequest)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetUsersListRequest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* GetUsersListRequest::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetUsersListRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetUsersListRequest)
  return target;
}

size_t GetUsersListRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetUsersListRequest)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData GetUsersListRequest::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    GetUsersListRequest::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*GetUsersListRequest::GetClassData() const { return &_class_data_; }


void GetUsersListRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<GetUsersListRequest*>(&to_msg);
  auto& from = static_cast<const GetUsersListRequest&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetUsersListRequest)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetUsersListRequest::CopyFrom(const GetUsersListRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetUsersListRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetUsersListRequest::IsInitialized() const {
  return true;
}

void GetUsersListRequest::InternalSwap(GetUsersListRequest* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.id_, other->_impl_.id_);
}

::PROTOBUF_NAMESPACE_ID::Metadata GetUsersListRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_test_2eproto_getter, &descriptor_table_test_2eproto_once,
...
class GetUsersListResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& resultcode(const GetUsersListResponse* msg);
};

const ::fixbug::ResultCode&
GetUsersListResponse::_Internal::resultcode(const GetUsersListResponse* msg) {
  return *msg->_impl_.resultcode_;
}
GetUsersListResponse::GetUsersListResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fixbug.GetUsersListResponse)
}
GetUsersListResponse::GetUsersListResponse(const GetUsersListResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  GetUsersListResponse* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetUsersListResponse)
}

inline void GetUsersListResponse::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
GetUsersListResponse::~GetUsersListResponse() {
  // @@protoc_insertion_point(destructor:fixbug.GetUsersListResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void GetUsersListResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.users_.~RepeatedPtrField();
  if (this != internal_default_instance()) delete _impl_.resultcode_;
}

void GetUsersListResponse::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void GetUsersListResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetUsersListResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetUsersListResponse::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* GetUsersListResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetUsersListResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetUsersListResponse)
  return target;
}

size_t GetUsersListResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetUsersListResponse)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData GetUsersListResponse::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    GetUsersListResponse::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*GetUsersListResponse::GetClassData() const { return &_class_data_; }


void GetUsersListResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<GetUsersListResponse*>(&to_msg);
  auto& from = static_cast<const GetUsersListResponse&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetUsersListResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetUsersListResponse::CopyFrom(const GetUsersListResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetUsersListResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetUsersListResponse::IsInitialized() const {
  return true;
}

void GetUsersListResponse::InternalSwap(GetUsersListResponse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetUsersListResponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_test_2eproto_getter, &descriptor_table_test_2eproto_once,
...
void UserServiceRpc::GetUsers(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetUsersListRequest*,
                         ::fixbug::GetUsersListResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method GetUsers() not implemented.");
  done->Run();
}
...
void UserServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    ...
    case 1:
      GetUsers(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetUsersListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetUsersListResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetUsersListRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetUsersListResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void UserServiceRpc_Stub::GetUsers(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
template<> PROTOBUF_NOINLINE ::fixbug::LoginRequest_TestEntry_DoNotUse*
Arena::CreateMaybeMessage< ::fixbug::LoginRequest_TestEntry_DoNotUse >(Arena* arena) {
...
template<> PROTOBUF_NOINLINE ::fixbug::GetUsersListRequest*
Arena::CreateMaybeMessage< ::fixbug::GetUsersListRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetUsersListRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::fixbug::GetUsersListResponse*
Arena::CreateMaybeMessage< ::fixbug::GetUsersListResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetUsersListResponse >(arena);
}
